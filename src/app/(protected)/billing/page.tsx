...
const BillingPage = () => {
    ...
    const price=(creditsToBuyAmount*0.5).toLocaleString("en-IN",{style:"currency",currency:"INR"});
  return (
    <div>
      ...
      <div className='bg-blue-50 px-4 py-2 rounded-md border border-blue-200 text-blue-700'>
        ...
        <p className='text-sm'>
            E.g. If your project has 100 files, you will need 50 credits to index it (means 1 credit per 2 files)
        </p>
